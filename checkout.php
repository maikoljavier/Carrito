      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h2 class="h3 mb-3 text-black">Detalles del Envio</h2>
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row mb-5">
                <div class="col-md-6">
                  <label for="c_email_address" class="text-black">Direccion Email <span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                ...
                <div class="collapse" id="ship_different_address">
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        <label for="c_diff_fname" class="text-black">Primar Nombre<span class="text-danger">*</span></label>
                    ...
                    <div class="form-group row mb-5">
                      <div class="col-md-6">
                        <label for="c_diff_email_address" class="text-black">Direccion Email<span class="text-danger">*</span></label>
              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    ?>
                      <tr>
                        <td><?php echo $arreglo[$i]['Nombre'];?><strong class="mx-2"></strong></td>
